...
INSERT INTO `colleague` (`id`, `name`, `description`, `phone`, `email`, `image`, `active`) VALUES
	...
	(5, 'gegreg', 'ergerg', 'reg', 'erg', 'filete0i27ivgvbjt4ippbrh6a32d0.jpg', 1);
...
-- Dumping data for table flora.event: ~0 rows (approximately)
...
-- Dumping data for table flora.knowledge_base: ~0 rows (approximately)
