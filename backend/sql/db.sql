...
INSERT INTO `colleague` (`id`, `name`, `description`, `phone`, `email`, `cv`, `image`, `active`) VALUES
	(1, 'Munkatárs neve', '', '+36 70 123 4567', 'minta@eamil.hu', NULL, NULL, 1),
	(2, 'Munkatárs2 neve', '', '+36 70 123 4567', 'minta@eamil.hu', NULL, NULL, 1),
	(3, 'Munkatár3 neve', '<p>dhgfdhfghsdfg</p>', '+36 70 123 4567', 'minta@eamil.hu', 'Szállásinformációk_Gárdián - 34754616.pdf', NULL, 1),
	(5, 'gegreg', '<p>asdasd</p>', 'reg', 'erg', NULL, 'filete0i27ivgvbjt4ippbrh6a32d0.jpg', 1);
...
INSERT INTO `event` (`id`, `title`, `description`, `address`, `image`, `date`) VALUES
	...
	(4, 'új esemény', '', 'fsdgdfgdfg', NULL, NULL);
...
INSERT INTO `news` (`id`, `title`, `short_description`, `description`, `image`, `date`, `active`) VALUES
	(1, 'Cím mkmdkfgnsdsdfgdfg', '<p>fgdfgdfgdfzuhrtz</p><p><br></p>', '<p>rtzrtzhrturtujzt</p><p>rtztrzrtz</p><p><br></p>', 'fileiuqrt23tppbv9lvd9k2uimdft7.jpg', '2017-02-10 01:00:00', 1),
	(2, 'dfsttzhooo', '<p>rzthrtzrtz</p><p style="text-align: center;">ghrhrthrth</p><ol><li>dfertert</li><li>retert</li></ol><p>retertert</p>', '', 'fileh2so6fjqbfn3kqfnobnp5sacip.jpg', '2017-02-09 01:00:00', 1),
	(3, 'Ez itt a cím', ' ', ' ', 'file4oh7c42jr1hp403k9hda0jdepa.jpg', '2017-02-17 01:00:00', 1),
	(6, 'zrtz', ' ', ' ', NULL, '2017-02-22 01:00:00', 0),
	(7, 'ijzui', ' ', ' ', NULL, '2017-02-18 01:00:00', 1),
	(8, 'rgerg', ' ', ' ', NULL, '2017-02-02 01:00:00', 0);
